...
namespace ExerciseTemplateBusinessRules.ItemEventReceivers.RfiItemEventReceiver
{
    /// <summary>
    /// List Item Events
    /// </summary>
    public class RfiItemEventReceiver : SPItemEventReceiver
    {
        ...
        private void SendOutRfiReopenedEmail(SPItemEventProperties properties)
        {
            ...
            var to = new List<SPUser> { respondentValue.User };
            var cc = new List<SPUser>();
        ...
        private void SendOutRfiClosedEmail(SPItemEventProperties properties)
        {
            ...
            var to = new List<SPUser> { pocValue.User };
            var cc = new List<SPUser>();
